...
<nav class="navbar navbar-expand-lg">
    ...
    <main class="wrapper">
        <div class="wrapper-body">
            <div class="row">
                <div class="col-xl-12">
                  <a class="btn btn-primary active-btn" href="#">Numbers</a>      
                                ...
                                <div class="table-responsive">
                                    <table id="datable_1" class="table table-hover display pb-5" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{{url('/PPC-landing-page/'.$Track['sid'])}}">{{ $Track['campaign'] }}</a></td>
                                                <td><a href="{{url('/PPC-landing-page/'.$Track['sid'])}}">{{ $Track['tracking'] }}</a></td>
                                                <td><a href="{{url('/PPC-landing-page/'.$Track['sid'])}}">{{ $Track['forwarded'] }}</a></td>
                                                <td><a href="{{url('/PPC-landing-page/'.$Track['sid'])}}">{{ $Track['totalCalls'] }}</a></td>
                                                <td><a href="{{url('/PPC-landing-page/'.$Track['sid'])}}">{{ $Track['lastCallTime'] }}</a></td>
                                                <td>
                                                    <a href="{{url('/PPC-landing-page/'.$Track['sid'])}}" style="background: none;border:none"><i class="fa-solid fa-eye"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
